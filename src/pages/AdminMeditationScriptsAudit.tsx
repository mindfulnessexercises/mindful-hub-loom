...
const PDF_FILES_ON_DISK = [
  ...
  "reflecting-on-a-positive-future.pdf",
  "reflecting-on-what-connected-you.pdf",
  "infinite-awareness.pdf",
  "starting-your-day-with-mindfulness.pdf",
  "dealing-with-addiction.pdf",
  "focusing-on-being-a-healthy-person.pdf",
  "relax-accept-break-habits-learn-and-be-happy.pdf",
  "visualizing-a-fountain-for-healing.pdf",
  "cultivating-a-sense-of-agency-to-overcome-trauma.pdf",
  "working-with-attachment-and-addiction.pdf",
  "a-safe-place-to-deal-with-pain.pdf",
  "changing-your-perspective-on-pain.pdf",
  "deep-state-of-relaxation-for-chronic-pain.pdf",
  "pain-body-scan.pdf",
  "pain-breathing-and-deep-body-scan.pdf",
  "making-room-for-pain-or-discomfort.pdf",
