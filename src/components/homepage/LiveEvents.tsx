...
const events = [
  {
    ...
    description: "A free introductory session exploring MBSR foundations and how to integrate mindfulness into daily life and professional practice.",
    free: true,
  },
  {
    ...
    description: "A CE-eligible deep-dive into trauma-sensitive mindfulness practices for therapists, counselors, and healthcare professionals.",
    free: false,
  },
  {
    ...
    description: "A weekly community practice session focused on mindful movement, suitable for all experience levels.",
    free: true,
  },
];
      ...
      <div className="space-y-4 lg:space-y-5 max-w-4xl mx-auto">
        {events.map((event, i) => (
          <motion.article
            ...
            className="group rounded-xl border border-border bg-card p-0 overflow-hidden shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-shadow duration-300"
          >
