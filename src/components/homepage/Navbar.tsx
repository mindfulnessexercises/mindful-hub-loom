...
const MENU: MenuGroup[] = [
  ...
  },
  {
    label: "Learn",
    blurb: {
      title: "Self-paced free courses",
      body: "Programs from a 28-day challenge to a 10-day Vipassana.",
      href: "/free-online-mindfulness-courses",
      cta: "See all courses →",
    },
    links: [
      { label: "All Free Courses", href: "/free-online-mindfulness-courses", icon: GraduationCap },
      { label: "28-Day Mindfulness Challenge", href: "/free-online-mindfulness-courses/28-day-mindfulness-challenge" },
      { label: "Mindfulness Made Easy", href: "/free-online-mindfulness-courses/mindfulness-made-easy" },
      { label: "10-Day Vipassana Course", href: "/free-online-mindfulness-courses/10-day-vipassana-course" },
